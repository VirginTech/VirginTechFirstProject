...
+(void)initializeObject
{
    ...
    if([dict valueForKey:@"beartank2"]==nil){
        [ObjectManager save_Object_Ability:@"beartank2" level:1 attack:1.0 defense:15.0 traveling:0.2 build:2];
    }
    ...
    if([dict valueForKey:@"beartank4"]==nil){
        [ObjectManager save_Object_Ability:@"beartank4" level:1 attack:2.0 defense:10.0 traveling:0.15 build:4];
    }
    if([dict valueForKey:@"beartank5"]==nil){
        [ObjectManager save_Object_Ability:@"beartank5" level:1 attack:5.0 defense:5.0 traveling:0.1 build:5];
    }
}
...
+(void)initializeCurrency
{
    ...
    if([dict valueForKey:@"Currency"]==nil){
        [GameManager save_Currency_All:100 dia:10];
    }
}

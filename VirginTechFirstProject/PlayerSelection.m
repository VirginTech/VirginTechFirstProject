...
- (id)init{
    ...
    CCLabelTTF* coin01label=[CCLabelTTF labelWithString:@" × 1" fontName:@"Verdana-Bold" fontSize:15];
    ...
    CCLabelTTF* coin02label=[CCLabelTTF labelWithString:@" × 2" fontName:@"Verdana-Bold" fontSize:15];
    ...
    CCLabelTTF* coin03label=[CCLabelTTF labelWithString:@" × 3" fontName:@"Verdana-Bold" fontSize:15];
    ...
    CCLabelTTF* coin04label=[CCLabelTTF labelWithString:@" × 4" fontName:@"Verdana-Bold" fontSize:15];
    ...
    CCLabelTTF* coin05label=[CCLabelTTF labelWithString:@" × 5" fontName:@"Verdana-Bold" fontSize:15];
